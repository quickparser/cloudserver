...
function processVersioningState(mst, vstat) {
    ...
    if (mst.versionId === undefined || mst.isNull || mst.isNullKey) {
    ...
    options.versioning = true;
    // NOTE: this is for backward-compatibility with older null
    // versions that are stored as versioned keys, we need to maintain
    // the 'nullVersionId' field to trace back to the null versioned
    // key
