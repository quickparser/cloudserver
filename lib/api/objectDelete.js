...
const { checkUserGovernanceBypass, ObjectLockInfo } = require('./apiUtils/object/objectLockHelpers');
    ...
    return async.waterfall([
        ...
        function checkGovernanceBypassHeader(bucketMD, objectMD, next) {
            ...
            if (hasGovernanceBypass && authInfo.isRequesterAnIAMUser()) {
                return checkUserGovernanceBypass(request, authInfo, bucketMD, objectMD, log, err => {
                    if (err) {
